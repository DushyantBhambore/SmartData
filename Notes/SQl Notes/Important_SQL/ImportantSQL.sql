...
Complex Logic:       If your logic involves several different possible outcomes or complex expressions, 
                     CASE is clearer and easier to manage.

SQL Standard:        CASE is part of the SQL standard and is supported by all major database systems
...
This function evaluates arguments in a particular order from the provided arguments list and always returns the first non-null value.
